...
//     series: [70, 75, 41, 27],
//     labels: ['Birthday', 'Anniversary', 'Romance', 'Just Because', 'Congratulations', 'Thank You', 'New Baby & Kids Gifts', 'Funeral, Sympathy, & Condolences', 'Get Well'],
//
//     chart: {
//         type: 'donut',
//     },
...
let category_options = {
    series: [70, 75, 41, 27],
    labels: ['Birthday', 'Anniversary', 'Romance', 'Just Because', 'Congratulations', 'Thank You', 'New Baby & Kids Gifts', 'Funeral, Sympathy, & Condolences'],
    chart: {
        type: 'donut',
    },
    colors: ['#6ab04c', '#2980b9', '#f39c12', '#d35400']
